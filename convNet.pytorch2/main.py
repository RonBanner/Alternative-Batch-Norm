...
# import sys
#
# x = torch.cuda.FloatTensor(10000, 1000).normal_()
...
# a = time.perf_counter()
# for i in range(10):
#     y = x.pow(2).mean(0).sqrt()
#     torch.cuda.synchronize() # wait for mm to finish
# b = time.perf_counter()
# print('square time {:.02e}s'.format(b - a))
#
#
#
# a = time.perf_counter()
...
#     torch.cuda.synchronize() # wait for mm to finish
# b = time.perf_counter()
# print('Abs time {:.02e}s'.format(b - a))
#
# #
# # a = time.perf_counter()
# # z = y**0.5
# # torch.cuda.synchronize() # wait for mm to finish
# # b = time.perf_counter()
# # print('square root time {:.02e}s'.format(b - a))
#
#
#
# sys.exit()
